...
public abstract class AbstractDraweeController<T, INFO> implements
  ...
  protected void submitRequest() {
    ...
    mHasFetchFailed = false;
    //在这里submit request的 这里调用的是PipelineDraweeController 的mDataSourceSupplier get方法  （而是在PipelineDraweeController初始化的时候通过PipelineDraweeControllerFactory的）
